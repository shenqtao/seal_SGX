	...
	*/
	...
	public:
		...
		*/
		...
		/**
		Returns the number of uint64_t allocated for each coefficient of each polynomial.
		*/
		int coeff_uint64_count() const;

		/**
		Returns the number of uint64_t allocated for each polynomial.
		*/
		int poly_uint64_count() const;

		/**
		Returns the number of uint64_t allocated for the entire array of polynomials.
	   */
		...
		*/
		uint64_t *pointer(int poly_index);
		...
		@throws std::out_of_range If poly_index is not within [0, size())
		*/
		const uint64_t *pointer(int poly_index) const;
