...
namespace seal
{
    ...
    public:
        ...
        virtual BigPoly encode(uint64_t value) const = 0;

        virtual void encode(uint64_t value, BigPoly &destination) const = 0;

        virtual uint32_t decode_uint32(const BigPoly &poly) const = 0;

        virtual uint64_t decode_uint64(const BigPoly &poly)const = 0;

        virtual BigPoly encode(int64_t value) const = 0;

        virtual void encode(int64_t value, BigPoly &destination) const = 0;

        virtual BigPoly encode(const BigUInt &value) const = 0;

        virtual void encode(const BigUInt &value, BigPoly &destination) const = 0;

        virtual int32_t decode_int32(const BigPoly &poly) const = 0;

        virtual int64_t decode_int64(const BigPoly &poly) const = 0;
        ...
        virtual BigPoly encode(int32_t value) const = 0;

        virtual BigPoly encode(uint32_t value) const = 0;

        virtual void encode(int32_t value, BigPoly &destination) const = 0;

        virtual void encode(uint32_t value, BigPoly &destination) const = 0;
    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        Encodes an unsigned integer (represented by uint64_t) into a plaintext polynomial.

        @param[in] value The unsigned integer to encode
        */
        virtual BigPoly encode(uint64_t value) const override;
        ...
        */
        virtual void encode(uint64_t value, BigPoly &destination) const override;

        /**
        Decodes a plaintext polynomial and returns the result as uint32_t.
        Mathematically this amounts to evaluating the input polynomial at X=2.

        @param[in] poly The polynomial to be decoded
        @throws std::invalid_argument if the output does not fit in uint32_t (#ifdef THROW_ON_DECODER_OVERFLOW)
        */
        virtual uint32_t decode_uint32(const BigPoly &poly) const override;

        /**
        Decodes a plaintext polynomial and returns the result as uint64_t.
        Mathematically this amounts to evaluating the input polynomial at X=2.

        @param[in] poly The polynomial to be decoded
        @throws std::invalid_argument if the output does not fit in uint64_t (#ifdef THROW_ON_DECODER_OVERFLOW)
        */
        virtual uint64_t decode_uint64(const BigPoly &poly) const override;

        /**
        Encodes a signed integer (represented by uint64_t) into a plaintext polynomial.
        ...
        */
        virtual BigPoly encode(int64_t value) const override;

        /**
        Encodes a signed integer (represented by int64_t) into a plaintext polynomial.
        ...
        @param[out] destination The polynomial to overwrite with the encoding
        */
        virtual void encode(int64_t value, BigPoly &destination) const override;
        ...
        */
        ...
        /**
        Decodes a plaintext polynomial and returns the result as int32_t.
        Mathematically this amounts to evaluating the input polynomial at X=2.

        @param[in] poly The polynomial to be decoded
        @throws std::invalid_argument if poly is not a valid plaintext polynomial
        @throws std::invalid_argument if the output does not fit in int32_t (#ifdef THROW_ON_DECODER_OVERFLOW)
        */
        virtual int32_t decode_int32(const BigPoly &poly) const override;

        /**
        Decodes a plaintext polynomial and returns the result as int64_t.
        Mathematically this amounts to evaluating the input polynomial at X=2.

        @param[in] poly The polynomial to be decoded
        @throws std::invalid_argument if poly is not a valid plaintext polynomial
        @throws std::invalid_argument if the output does not fit in int64_t (#ifdef THROW_ON_DECODER_OVERFLOW)
        */
        virtual int64_t decode_int64(const BigPoly &poly) const override;
        ...
        */
        ...
        /**
        Encodes a signed integer (represented by int32_t) into a plaintext polynomial.
        ...
        @param[in] value The signed integer to encode
        */
        virtual BigPoly encode(int32_t value) const override
        {
            return encode(static_cast<int64_t>(value));
        }

        /**
        Encodes an unsigned integer (represented by uint32_t) into a plaintext polynomial.

        @param[in] value The unsigned integer to encode
        */
        virtual BigPoly encode(uint32_t value) const override
        {
        ...
        @param[out] destination The polynomial to overwrite with the encoding
        */
        virtual void encode(int32_t value, BigPoly &destination) const override
        {
        ...
        @param[out] destination The polynomial to overwrite with the encoding
        */
        virtual void encode(uint32_t value, BigPoly &destination) const override
        {
    ...
    */
    ...
    public:
        ...
        */
        ...
        @param[in] poly The polynomial to be decoded
        @throws std::invalid_argument if poly is not a valid plaintext polynomial
        @throws std::invalid_argument if the integral part does not fit in int64_t (#ifdef THROW_ON_DECODER_OVERFLOW)
        */
    ...
    */
    ...
    public:
        ...
        @throws std::invalid_argument if plain_modulus is not at least base
        */
        IntegerEncoder(const BigUInt &plain_modulus, uint64_t base = 2);
    ...
    */
    ...
    public:
        ...
        @throws std::invalid_argument if base is not an integer and at least 2
        */
        FractionalEncoder(const BigUInt &plain_modulus, const BigPoly &poly_modulus, int integer_coeff_count, int fraction_coeff_count, uint64_t base = 2);
