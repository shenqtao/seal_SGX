...
//	parms_sgx.coeff_modulus() = ChooserEvaluator::default_parameter_options().at(conf_SGX.p_coeff_modulus); //this line itself is the origin
  std::map<int, BigUInt> tmp = ChooserEvaluator::default_parameter_options();
  parms_sgx.coeff_modulus() = tmp[conf_SGX.p_coeff_modulus];
