...
namespace seal
{
    namespace util
    {
        ...
        void exponentiate_poly(const uint64_t *poly, int poly_coeff_count, int poly_coeff_uint64_count, const uint64_t *exponent,
            int exponent_uint64_count, int result_coeff_count, int result_coeff_uint64_count, uint64_t *result, MemoryPool &pool);

        void exponentiate_poly_polymod_coeffmod(const uint64_t *poly, const uint64_t *exponent, int exponent_uint64_count,
