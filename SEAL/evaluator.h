...
namespace seal
{
    ...
    */
    ...
    public:
        ...
        */
        void exponentiate(const BigPolyArray &encrypted, uint64_t exponent, BigPolyArray &destination);
        ...
        @throws std::invalid_argument if the exponent is zero
        */
        BigPolyArray exponentiate(const BigPolyArray &encrypted, uint64_t exponent)
        {
            BigPolyArray result;
    ...
    private:
        ...
        void relinearize_one_step(const uint64_t *encrypted, int encrypted_size, uint64_t *destination, util::MemoryPool &pool);
